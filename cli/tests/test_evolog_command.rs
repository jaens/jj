...
fn test_evolog_with_or_without_diff() {
    ...
    │     1     : <<<<<<< conflict 1 of 1
    │     2     : %%%%%%% rebase destination (zzzzzzzz 00000000) compared with qpvuntsm c664a51b
    │     3     : -foo
    ...
    @@ -1,7 +1,1 @@
    -<<<<<<< conflict 1 of 1
    -%%%%%%% rebase destination (zzzzzzzz 00000000) compared with qpvuntsm c664a51b
    --foo
...
fn test_evolog_squash() {
    ...
    │ │ │     2     : +++++++ side #1
    │ │ │     3    1: squashed 2
    │ │ │     4     : %%%%%%% side #2 compared with base #1
    │ │ │     5     : +fourth
    │ │ │     6    1: %%%%%%% side #3 compared with base #2
    │ │ │     7     : +fifth
